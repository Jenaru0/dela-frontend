          ...
          <div className="mb-8 bg-white/80 rounded-2xl p-6 shadow-lg border border-[#ecd8ab]">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-[#3A3A3A]">Tus favoritos guardados</h2>
                  <p className="text-[#9A8C61] text-sm">Acceso rápido a tus productos preferidos</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                {favorites.length > 0 && (
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#CC9F53]">{favorites.length}</div>
                    <div className="text-xs text-gray-600">Productos guardados</div>
                  </div>
                )}
                <Link
                  href="/productos"
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="bg-gradient-to-r from-white/95 to-[#FAF3E7]/50 rounded-2xl p-6 shadow-lg border border-[#ecd8ab] mt-8">
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3">                      <Button
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (confirm(`¿Estás seguro de que quieres eliminar todos los ${favorites.length} favoritos? Esta acción no se puede deshacer.`)) {
                            favorites.forEach(fav => handleRemoveFavorite(fav.producto.id.toString()));
                          }
                        }}
                      >
