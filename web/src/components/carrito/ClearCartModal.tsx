...
import { AlertTriangle, X, Trash2, ShoppingBag, Package } from "lucide-react";
...
const ClearCartModal: React.FC<ClearCartModalProps> = ({
  ...
  const handleConfirm = () => {
    ...
    >
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full mx-auto border border-gray-200">        {/* Header profesional */}
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900">Vaciar Carrito</h2>
            ...
            <div className="flex items-center space-x-4">
              <div className="flex-shrink-0">
                <div className="w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center relative">
                  <ShoppingBag className="w-8 h-8 text-gray-400" />                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-amber-500 rounded-full flex items-center justify-center">
                    <span className="text-white font-bold text-xs">{cartCount}</span>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            <h5 className="font-medium text-blue-900 text-sm mb-2 flex items-center">
              ...
              <li className="flex items-center">
                ...
                Se eliminarán {cartCount} {cartCount === 1 ? 'producto' : 'productos'}
              </li>
              <li className="flex items-center">
                <div className="w-1.5 h-1.5 bg-amber-500 rounded-full mr-2"></div>
                Perderás cualquier descuento aplicado
              </li>
              <li className="flex items-center">
